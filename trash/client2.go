...
// 	go func() {
// 		chatInputHandler(ctx, conn, chatID, reqUID, done)
// 	}()
...
// func chatInputHandler(ctx context.Context, conn *websocket.Conn, chatID domain.ID, userID domain.ID, done chan interface{}) {
